...
import useChoroplethMap from "./useChoroplethMap";
...
// Placeholder "week ending" date — swap for the live value once wired to the
// real API/CSV data. Formatted the same way as the sparkline card's footer
// (see StatGrid.jsx `fmt`) instead of a raw "MM/DD" string.
const WEEK_ENDING = fmtDate(new Date(2026, 6, 25));
  ...
  return (
    <>
      ...
      >
        ...
        <p className="text-2xs font-body whitespace-nowrap">Data as of: {WEEK_ENDING}</p>
      </div>
    </>
  );
}
